...
\r
In the end I'll elaborate a little on the shortcomings of the chosen validator [entityshape](https://github.com/dpriskorn/entityshape).\r
\r
（中文）\r
\r
使用實體架構模式和實體型態批量驗證維基數據專案\r
\r
10-29， 00：30–01：00 （亞洲/台北）， 主場\r
\r
我將介紹一項Notebook，任何人都可以根據SPARQL輕鬆查詢，使用Notebook來批量檢查一批專案。\r
\r
在會議期間，我將用Notebook 展示並解釋，為什麼使用實體架構模式進行批量驗證，可以幫助編輯者有效地管理維基數據中的專案項目集。\r
\r
批量驗證維基數據專案在先前並不常見。我想寫程式幫忙改變這種情況。\r
所以我建立了Notebook，任何人皆可以根據SPARQL輕鬆查詢，使用Notebook來批量檢查一批專案。\r
\r
在會議期間，我將解釋如何建立一項簡單的實體架構模式，並使用PAWS中的架構展示Notebook。\r
\r
所有人都可以非常輕鬆地檢查並關注一組專案，匯集新的QueryBuilder，與一項簡單的現有實體架構模式，或是從中調整一項現有的實體架構模式，\r
\r
使用實體架構模式進行批量驗證，可以幫助編輯者有效地管理維基數據中的專案項目集。\r
\r
最後我會詳細說明關於所選驗證器[實體型態]（https://github.com/dpriskorn/entityshape）的缺點。`,"Speaker names":["Dennis Priskorn"],Room:{en:"Main program"},Start:"2023-10-28T16:30:00+00:00",End:"2023-10-29T01:00:00+08:00"},{ID:"C8BLHU","Proposal title":"Semi-automatic Tagging of Images on Wikimedia Commons | 維基共享資源上的半自動圖像標記",Abstract:`\`(EN)\`\r
...
* Lexemes Wikidata Project as a source of knowledge and preservation of local languages - Michael Lim\r
